...
public class OsafeGeo {
    ...
    private static final String GEOPT_REQUEST_URL = Util.getProductStoreParm("GMAP_GEOPT_API_URL");
     ...
     *
     * @param address A <code>String</code> instance, can be <code>null</code>
     * @return A <code>OsafeGeo</code> instance
     */
    public static OsafeGeo fromAddress(String address) {
        return ((address == null) || (address.length() == 0)) ? EmptyOsafeGeo : getInstanceFromAddress(address);
    }
