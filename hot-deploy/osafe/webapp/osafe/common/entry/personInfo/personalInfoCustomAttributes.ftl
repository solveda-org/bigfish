                    ...
                    <#elseif customPartyAttribute.Type == 'CHECKBOX'>
                        ...
                        <#if valueList?has_content>
                            ...
                            <#list values as value>
                                 ...
                                 <#assign valueTrim = value?string?trim />
                                 <input type="checkbox" name="${customPartyAttribute.AttrName}" value="${valueTrim?upper_case}" <#if attrValue?contains(valueTrim?upper_case)>checked = "checked"</#if>/>${valueTrim}
                            </#list>
                        </#if>
