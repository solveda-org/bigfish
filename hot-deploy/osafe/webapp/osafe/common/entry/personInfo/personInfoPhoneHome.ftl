...
<#if homePhonePartyContactDetails?has_content>
     <#assign homePhonePartyContactDetails = Static["org.ofbiz.entity.util.EntityUtil"].filterByDate(homePhonePartyContactDetails?if_exists)/>
    <#assign homePhonePartyContactDetail = Static["org.ofbiz.entity.util.EntityUtil"].getFirst(homePhonePartyContactDetails?if_exists)/>
</#if>
