        ...
        <#if attachUrl02?has_content>
            <div class="pdpAttach02" id="js_pdpAttach02">
		       <div class="displayBox">
		         ...
		         <span>
		             <a href="javascript:void(0);" onclick="javascript:newPopupWindow('<@ofbizContentUrl>${attachUrl02!}</@ofbizContentUrl>', '${windowName}')">${uiLabelMap.ProductAttachment02Link}</a>
		         </span>
		       </div>
		    </div>
      ...
      <#if variantAttachUrl02?has_content>
	      <div class="pdpAttach02" id="js_pdpAttach02_${key}" style="display:none">
	       <div class="displayBox">
	         <label>${uiLabelMap.ProductAttachmentCaption}</label>
	         <span>
	             <a href="javascript:void(0);" onclick="javascript:newPopupWindow('<@ofbizContentUrl>${variantAttachUrl02!}</@ofbizContentUrl>', '${windowName}')">${uiLabelMap.ProductAttachment02Link}</a>
	         </span>
	       </div>
	      </div>
	  <#else>
