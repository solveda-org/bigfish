        ...
        <#if attachUrl01?has_content>
            <div class="pdpAttach01" id="js_pdpAttach01">
		       <div class="displayBox">
		         ...
		         <span>
		             <a href="javascript:void(0);" onclick="javascript:newPopupWindow('<@ofbizContentUrl>${attachUrl01!}</@ofbizContentUrl>', '${windowName}')">${uiLabelMap.ProductAttachment01Link}</a>
		         </span>
		       </div>
		    </div>
      ...
      <#if variantAttachUrl01?has_content>
	      <div class="pdpAttach01" id="js_pdpAttach01_${key}" style="display:none">
	       <div class="displayBox">
	         <label>${uiLabelMap.ProductAttachmentCaption}</label>
	         <span>
	             <a href="javascript:void(0);" onclick="javascript:newPopupWindow('<@ofbizContentUrl>${variantAttachUrl01!}</@ofbizContentUrl>', '${windowName}')">${uiLabelMap.ProductAttachment01Link}</a>
	         </span>
	       </div>
	      </div>
	  <#else>
