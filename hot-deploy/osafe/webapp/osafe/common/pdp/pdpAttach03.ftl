        ...
        <#if attachUrl03?has_content>
            <div class="pdpAttach03" id="js_pdpAttach03">
		       <div class="displayBox">
		         ...
		         <span>
		             <a href="javascript:void(0);" onclick="javascript:newPopupWindow('<@ofbizContentUrl>${attachUrl03!}</@ofbizContentUrl>', '${windowName}')">${uiLabelMap.ProductAttachment03Link}</a>
		         </span>
		       </div>
		    </div>
      ...
      <#if variantAttachUrl03?has_content>
	      <div class="pdpAttach03" id="js_pdpAttach03_${key}" style="display:none">
	       <div class="displayBox">
	         <label>${uiLabelMap.ProductAttachmentCaption}</label>
	         <span>
	             <a href="javascript:void(0);" onclick="javascript:newPopupWindow('<@ofbizContentUrl>${variantAttachUrl03!}</@ofbizContentUrl>', '${windowName}')">${uiLabelMap.ProductAttachment03Link}</a>
	         </span>
	       </div>
	      </div>
	  <#else>
